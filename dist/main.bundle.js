...
var BoundariesFrontComponent = /** @class */ (function () {
    ...
    BoundariesFrontComponent.prototype.filterToggle = function (filter) {
        ...
        var boundary = this.data.find(function (d) { return d.Boundary === filter.Boundary; });
...
var ResultComponent = /** @class */ (function () {
    ...
    ResultComponent.prototype.saveOperationLog = function () {
        ...
        try {
            ...
            this.dataService.saveOperationLog({
                ...
                _this.containerHeight = _this.elementView.nativeElement.offsetHeight;
    ...
    ], ResultComponent.prototype, "elementView", void 0);
        ...
        switch (item.id) {
            ...
            case "topics":
                if (this.sharedDataService.data.topic) {
                    this.router.navigate(['/account/topic',
